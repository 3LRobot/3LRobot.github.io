...
![СтикернаПульте](/assets/images/r3sticker.jpg){: style="display: block; margin: 0 auto"}

![ПривязкаПульта](/assets/images/go2_rc_binding.jpeg){: style="display: block; margin: 0 auto"}
...
Высота стойки, Высота подъема лап, Скорость бега теперь устанавливается глобально для всех походок из меню More Function в **Go**, для перехода в меню нажмите три точки справа сверху находять в **Go**
...
![Обновленные команды управления](/assets/images/go2_newcmd.jpeg){: style="display: block; margin: 0 auto"}
