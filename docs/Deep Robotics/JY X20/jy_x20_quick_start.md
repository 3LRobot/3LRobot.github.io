...
![Схема собаки](/assets/images/x20_start_pos.png){: width="600px" style="display: block; margin: 0 auto"}
...
![Задняя панель](/assets/images/x20_button.png){: width="800px" style="display: block; margin: 0 auto"}

5) Подключение пульта управления.
Нажмите и удерживайте кнопку питания, чтобы включить джойстик (пожалуйста, зарядите джойстик при первом использовании), и откройте приложение DEEProbotics, чтобы подключиться к WiFi Jueying X20.
...
![Пульт](/assets/images/sticks_jy.png){: width="1000px" style="display: block; margin: 0 auto"}
